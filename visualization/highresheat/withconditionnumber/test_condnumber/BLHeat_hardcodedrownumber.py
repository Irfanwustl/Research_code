...
filesdf=[pd.read_csv(fp,nrows=5,sep="\t") for fp in files]    ########
...
outdf.to_csv(infolder+"_forheat_hardcodedrownumfortesting"+".txt",sep="\t")
inverteddf.to_csv(infolder+"_forheat_hardcodedrownumfortesting_inverted"+".txt",sep="\t")
...
heatname=infolder+"_condnumber_"+str(condnumber)+"_hardcodedrownumfortesting_heat"+".pdf"

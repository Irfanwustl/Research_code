...
ggplot(to_bind,aes(x=PC1,y=PC2,shape=for_symb,col=col_str,fill=col_str))+geom_point()+scale_shape()+scale_fill_brewer(values = mycolors)+guides(shape=guide_legend("Origin"),fill=FALSE,color=guide_legend("Cell Type"))

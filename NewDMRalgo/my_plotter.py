...
def display(
    ...
    **kwargs
    ...
    if type(signal) != np.ndarray:
        ...
        colnames=signal.columns ##############
        cpgnames=signal.index.to_list()
    ...
    matplotlib_options = {
        "figsize": (10, 2.5 * n_features),  # figure size
    }
    ...
    for axe, sig in zip(axarr, signal.T):
        ...
        axe.set_ylabel(colnames[colcount]) ###############
       # axe.set_xticklabels(cpgnames,rotation='vertical',fontsize=10)

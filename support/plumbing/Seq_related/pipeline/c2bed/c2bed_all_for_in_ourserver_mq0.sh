...
echo "medgenome_bam_pp_sorted_renamedfor_c2bed..."

file_directory="medgenome_bam_pp_sorted_renamedfor_c2bed"
outdir="${file_directory}_pp_m0_Bedout"
...
do
	...
	biscuit pileup -q $cores -m 0 -w ${outdir}/${fin}_pileup.txt -o ${outdir}/${fin}_pileup.txt  /home/ialahi/software/all_sequences.fa ${file_directory}/${fin}

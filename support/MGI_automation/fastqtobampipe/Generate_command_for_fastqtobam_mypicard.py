...
for r1fastq in R1fastqs:
    ...
    bsub_command="bsub -M 48000000 -R 'select[mem>48000] rusage[mem=48000]' -oo "+outfolder_logs+"/"+r1fastq_base+".log" + "  -q general -a 'docker(broadinstitute/picard)' java -jar /storage1/fs1/aadel/Active/work/software/picard.jar FastqToSam F1="+r1fastq+" F2="+r2fastq_path+     "  O="+outforthisbam+"/"+r1fastq_base+".bam"+" SM="+r1fastq_base+"\n\n"

...
class AllCompartmentMean:
    ...
    def headerfix(self,newdf):
        ...
        outdf = newdf.rename(columns={0: "chrom", 1: "start", 2: "end", 3: "q", 4: celltype + "-others", 5: "#cpg", 6: "p(MWU)",7: "p(2dks)", 8: celltype, 9: "others"})
    ...
    def setupparallalrun(self,rowmeandf):
        ...
        chunk=math.floor(trdGroupSize/totalrow)

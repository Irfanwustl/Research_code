...
class ReadAssign:
    ...
    def read_SMcpg_associate(self, smsubset, read):
        ...
        if read.query_name=='A00580:76:HFLG2DSXX:3:2352:16957:10316':
            print(read.query_name)
            
            print(result)

            print(smsubset.shape[0])

        if len(result)<self.pattern_percentage*smsubset.shape[0]:
            result=[]
    ...
    def celltypeassigntoread(self,readCpgAss,read):
        ...
        if(read.query_name=="A00580:76:HFLG2DSXX:4:2551:7419:9298"):
            print(read.query_name)
            print(flat_list)

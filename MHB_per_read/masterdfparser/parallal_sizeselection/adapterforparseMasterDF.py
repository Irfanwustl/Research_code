...
minfraglength=[-math.inf,-math.inf,-math.inf] #[100,100,100]#[-math.inf,-math.inf,-math.inf] #[100,100,100] #
maxfraglength=[math.inf,math.inf,math.inf] #[150,150,150]#[math.inf,math.inf,math.inf] #[150,150,150] #

###########################################################################

#adjustedDF=adjustedDF[(adjustedDF['assignedcelltype']!="NotAssigned") & (adjustedDF['assignedcelltype']!="lowmapq") & (adjustedDF['assignedcelltype']!="DupRead") ] ???????????




pMDF=parseMasterDF.ParseMasterDF(adjustedDF,celllist,minfraglength=minfraglength,maxfraglength=maxfraglength,percentCpGcoverforrejection=percentcpgforrejection,minCpGforpositivecall=mincpgforpoditivecall,rejectionmode=rejectionMode)
